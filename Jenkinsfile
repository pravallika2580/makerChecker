pipeline {
    ...
    parameters {
        ...
        string(name: 'PLAYWRIGHT_BASE_URL', defaultValue: 'http://localhost:8111/CheckerMaker/', description: 'Playwright application URL')
    ...
    stages {
        ...
        stage('Build Backend Jar') {
            ...
            steps {
                ...
                bat 'mvn -f "Fund\\audit-library\\pom.xml" install -DskipTests'
                bat 'mvn -f "Fund\\rbc-library\\pom.xml" install -DskipTests'
